...
from generative.networks.schedulers.scheduler import Scheduler
...
class DDIMScheduler(Scheduler):
    ...
    def step(
        ...
        alpha_prod_t = self.alphas_cumprod[timestep]
        alpha_prod_t_prev = self.alphas_cumprod[prev_timestep] if prev_timestep >= 0 else self.final_alpha_cumprod
        # print(f'prev_timestep {prev_timestep}, timestep {timestep}, alpha_prod_t_prev {alpha_prod_t_prev }, alpha_prod_t {alpha_prod_t}')
    ...
    def reversed_step(
        ...
        # alpha_prod_t = self.alphas_cumprod[timestep]
        # alpha_prod_t_prev = self.alphas_cumprod[prev_timestep] #if prev_timestep < self.num_train_timesteps else self.final_alpha_cumprod
